...
output:
  ...
  html_document:
    df_print: paged
---
```{r creación de objetos para los cálculos, , include=FALSE}
...
```
### Análisis de la defensa de los equipos por periodos
*Periodo 1
```{r}

#Para el equipo con mas victorias en promedio en el periodo 1

equipo1_periodo1 <- df_period1 %>% filter(TEAM =="Golden State Warriors")

equipo2_periodo1 <- df_period1 %>% filter(TEAM == "Los Angeles Lakers")
