...
PromFTA2 <- PromFTA2[order(PromFTA1$promedio, decreasing = TRUE),]
...
* Con respecto al coeficiente de variación se puede decir que en el primer período. tanto el equipo con más victorias como el que tiene menos victorias, tienen un coeficiente de variación bajo lo que quiere decir que no hay nigún valor que marque una diferencia en el éxito de los equipos.
