...
DF_period1_STL_max <- df_period1 %>% filter(TEAM== "Los Angeles Lakers") %>% select(STL)
CV_period1_max <- DF_period1_STL_max %>% summarise(sd(STL)/mean(STL))
...
DF_period1_STL_min <- df_period1 %>% filter(TEAM== "Golden State Warriors") %>% select(STL)
CV_period1_min <- DF_period1_STL_min %>% summarise(sd(STL)/mean(STL))
