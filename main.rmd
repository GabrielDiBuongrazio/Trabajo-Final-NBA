...
library(tinytex)
NBA_G1_1_ <- read_excel("~/Base de datos NBA/NBA G1.xlsx")
View(NBA_G1_1_)
df <- NBA_G1_1_
df <- df %>%
...
```{r Análisis de Variables Defensivas, echo=FALSE}

#Primer Periodo

#Correlación Entre Victorias y Rebotes Ofensivos
#El mejor y el peor equipo de la temporada
...
GrCVperiod1 <- ggplot(CV_period1,aes(x=TEAM,y= CV, color = TEAM)) + geom_col(size=3.0)  + theme_classic() + labs(title="Coeficiente de Variación (Primer Periodo)")
GrCVperiod1
