...
Grperiod1 <- ggplot(df_period1,aes(x=W, y=DREB, color=TEAM)) + geom_point(size=3.0) + theme_classic() + labs(title= "Victorias vs REBOTES (primer periodo)", x= "WINS", y= "REBOTES") +  geom_smooth(size=3.0, method = "lm", formula = y ~ x)
Grperiod1
...
Grperiod2 <- ggplot(df_period2,aes(x=W, y=DREB, color=TEAM)) + geom_point(size=3.0) + theme_classic() + labs(title= "Victorias vs REBOTES (segundo periodo)",x= "WINS", y= "REBOTES") + geom_smooth(size=3.0,method = "lm", formula = y ~ x) 
Grperiod2
...
###Gráfico de dispersión
Grperiod3 <- ggplot(df_period3,aes(x=W, y=DREB, color=TEAM)) + geom_point(size=3.0) + theme_classic() + labs(title= "Victorias vs REBOTES (tercer periodo)",x= "WINS", y= "REBOTES") + geom_smooth(size=3.0,method = "lm", formula = y ~ x) 
Grperiod3
### Gráfico de barras Coeficiente de Variación 2
