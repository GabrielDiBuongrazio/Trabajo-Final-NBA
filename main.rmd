...
GrperiodCV11 <- ggplot(DF_period1_STL11,aes(x=STL, y= W, color=TEAM)) + geom_point(size=3.0) + theme_classic()
GrperiodCV11
...
GrperiodCV22 <- ggplot(DF_period2_STL22,aes(x=STL, y= W, color=TEAM)) + geom_point(size=3.0) + theme_classic()
GrperiodCV22
...
GrperiodCV33 <- ggplot(DF_period3_STL33,aes(x=STL, y= W, color=TEAM)) + geom_point(size=3.0) + theme_classic()
GrperiodCV33
...
```{r Análisis de Variables ofensivas, echo=FALSE}
...
print(mw_rebotes_ofensivos1)
  rebotes_ofensivos1 <- df_period2 %>% select(W, OREB, TEAM)
mw_rebotes_ofensivos1 <-rebotes_ofensivos1 %>% group_by(TEAM) %>% summarise(promedio = mean(W))
print(mw_rebotes_ofensivos1)
#Best1
...
cor_rebotes_ofensivos2best <- cor(rebotes_ofensivos1best, method = "pearson")
cor_rebotes_ofensivos2best <- round(cor_rebotes_ofensivos1best, digits = 2)
#Worst1
...
cor_rebotes_ofensivos3best <- cor(rebotes_ofensivos1best, method = "pearson")
...
#Primer periodo
  Groperiod1 <- ggplot(df_period1,aes(x=W, y=OREB, color=TEAM)) + geom_point(size=3.0) + theme_classic() + labs(title= "Victorias vs REBOTES OFENSIVOS (primer periodo)", x= "WINS", y= "REBOTES OFENSIVOS") +  geom_smooth(size=3.0,method = "lm")
  Groperiod1

  
#Tiros de 3 Puntos Encestados


#Segundo Periodo
  
#Rebotes Ofensivos
  Groperiod2 <- ggplot(df_period2, aes(x=W, y=OREB, color=TEAM)) + geom_point(size=3.0) + theme_classic() + labs(title= "Victorias vs REBOTES OFENSIVOS (segundo periodo)", x= "WINS", y= "REBOTES OFENSIVOS") +  geom_smooth(size=3.0,method = "lm")
  Groperiod2

#Tercer Periodo
  
#Rebotes Ofensivos
  Groperiod3 <- ggplot(df_period3, aes(x=W, y=OREB, color=TEAM)) + geom_point(size=3.0) + theme_classic() + labs(title= "Victorias vs REBOTES OFENSIVOS (tercer periodo)", x= "WINS", y= "REBOTES OFENSIVOS") +  geom_smooth(size=3.0,method = "lm")
  Groperiod3
```
## Conclusión
