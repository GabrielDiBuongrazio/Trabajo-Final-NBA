...
```{r análisis de las variables con mayor desvicación}
...
view(cv_variables)
```
```{r Correlación entre victorias y rebotes ofensivos, echo=FALSE}
#Primer Periodo
...
```{r Correlación entre victorias y tiros de 3 realizados (3PA)}
...
```{r Cálculo del CV de los puntos de 3 intentados}
...
```{r Promedio del Número de Tiros Libres, echo=FALSE}
###PRIMERA TEMPORADA
