...
GRAC1<- plot_ly(data=df_period1,x=~TEAM, y=~W,name ="TEAMS", type = "box", mode = "marker")%>% layout(title = "Victorias del Primer Período", xaxis = list(title="Equipos"), yaxis = list(title = "Victorias"))
GRAC1
```
...
```{r,echo=FALSE}
#Gráfico de caja y bigotes de equipos con mas y menos victorias en promedio
GRAC2<- plot_ly(data=df_period2,x=~TEAM, y=~W, type = "box") %>% layout(title = "Victorias del Segundo Período", xaxis = list(title="Equipos"), yaxis = list(title = "Victorias")) 
GRAC2
```
...
```{r,echo=FALSE}
#Gráfico de caja y bigotes de equipos con mas y menos victorias en promedio
GRAC3<- plot_ly(data=df_period3,x=~TEAM, y=~W,name = "Tercer Período",  type = "box")%>% layout(title = "Victorias del Tercer Período", xaxis = list(title="Equipos"), yaxis = list(title = "Victorias"))
GRAC3 
```
