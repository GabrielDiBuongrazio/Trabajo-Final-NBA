...
```{r,echo=FALSE}
#Gráfico de barras de promedio de victorias de los equipos
GRAB2<- plot_ly(data=w_period_2,x=~TEAM, y=~w_prom, name = "Segundo Período", mode= "markers",size= 10, color ="green") %>% layout(title = "Media de victorias", xaxis = list(title="Equipos"), yaxis = list(title = "Victorias"))
GRAB2
```
